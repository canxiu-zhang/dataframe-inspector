...
def sample_df():
    ...
    return pd.DataFrame({
        ...
        'nested': [
            {'user': {'name': 'Alice', 'id': 100}, 'metadata': {'created': '2024-01-01'}},
            {'user': {'name': 'Bob', 'id': 200}, 'metadata': {'created': '2024-01-02'}},
            {'user': {'name': 'Charlie', 'id': 300}, 'metadata': {'created': '2024-01-03'}}
        ]
    })
